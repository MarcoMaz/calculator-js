///VARIABLES///
const myCalculator = new Calculator('display')
const operatorControls = document.getElementsByClassName('operator')
const numberControls = document.getElementsByClassName('number')
